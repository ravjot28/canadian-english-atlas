...
public interface FirebaseRealtimeDatabaseRepository<T, ID> {
   ...
   * @param uriVariables The optional uri variables corresponding to placeholders in the
  ...
  /**
   * Updates an existing document. If the document does not exist, it will be created. The document
   * must have an id.
   * 
