    ...
    if (this.props.currentUser) {
      ...
      menuItems = [
        <Menu.Item key="/addAudio">
          <Link to="/addAudio">Add Audio</Link>
        </Menu.Item>,
        <Menu.Item key="/aboutUs">
          <Link to="/aboutUs">About</Link>
        </Menu.Item>,
        <Menu.Item key="/downloadAudio">
          <Link to="/downloadAudio">Download Audio</Link>
        </Menu.Item>,
        <Menu.Item key="/faq">
      ...
      <Header className="app-header">
        <div className="container">
          <div className="app-title">
            <Link to="/">{"Canadian English Atlas"}</Link>
          </div>
          <Menu
            className="app-menu"
            mode="horizontal"
...
function ProfileDropdownMenu(props) {
  ...
  return (
    ...
    >
      <a href={hrefLink} className="ant-dropdown-link">
